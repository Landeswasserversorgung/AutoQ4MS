function sqlCmd = createSimpleSQLUpdateCommandArray(schemaName, tableName, columnName, value, whereConditions)
...
%   sqlCmd           - SQL-Update-Statement (String)
    ...
    if isnumeric(value)
        ...
        sqlArrayStr = sprintf('ARRAY[%s]', strjoin(string(value), ','));
        valStr = sqlArrayStr;
    ...
    elseif islogical(value)
        ...
        sqlArrayStr = sprintf('ARRAY[%s]', strjoin(boolStr, ','));
        valStr = sqlArrayStr;
    else
