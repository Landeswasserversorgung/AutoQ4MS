...
function update_header(rootDir)
    ...
    project = 'AutoQ4MS';
    license = [ ...
    '% License: GNU General Public License v3.0 (GPL-3.0) or later.' nl ...
    '%          See the LICENSE file or https://www.gnu.org/licenses/gpl-3.0.html for details.' ];

    %license = 'GNU General Public License v3.0 (GPL-3.0) or later. See the LICENSE file or https://www.gnu.org/licenses/gpl-3.0.html for details.';
    ...
    '% License           : GNU General Public License v3 (GPL-3.0) see THIRD_PARTY_LICENSES/LICENSE_zmat_Qianqian_Fang.txt' nl ...
    '% Note              : Third-party component included with AutoQ4MS.' nl ...
    '% ========================== AutoQ4MS HEADER END ==========================' nl nl ];
